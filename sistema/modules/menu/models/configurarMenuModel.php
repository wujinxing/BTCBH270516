...
class configurarMenuModel extends Model{
    ...
    private function _set(){
        ...
        $this->_idDominio       = Aes::de(Formulario::getParam('_idDominio'));    /*se decifra*/
        $this->_idModulo        = Aes::de(Formulario::getParam('_idModulo'));
        $this->_idMenuPrincipal = Aes::de(Formulario::getParam('_idMenuPrincipal'));
        $this->_idOpcion        = Aes::de(Formulario::getParam('_idOpcion'));
        $this->_dominio         = Formulario::getParam(T3.'txt_dominio');
        $this->_modulo          = Formulario::getParam(T3.'txt_modulo');
        $this->_menu            = Formulario::getParam(T3.'txt_menu');
        $this->_opcion          = Formulario::getParam(T3.'txt_opcion');
        $this->_alias           = Formulario::getParam(T3.'txt_alias');
        $this->_url             = Formulario::getParam(T3.'txt_url');
        $this->_icono           = Formulario::getParam(T3.'txt_icono');
        $this->_class           = Formulario::getParam(T3.'txt_class');
        $this->_activo          = Formulario::getParam(T3.'chk_activo');
        $this->_orden           = Formulario::getParam(T3.'txt_orden');
