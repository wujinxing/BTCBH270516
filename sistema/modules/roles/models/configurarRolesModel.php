...
class configurarRolesModel extends Model{
    ...
    private function _set(){
        ...
        $this->_clave = $this->post('CRDCRchk_clave');
    ...
    public function mantenimientoRol(){
        $query = "call sp_rolesConfigurarRolesMantenimiento(:flag,:key,:rol,:activo,:clave,:usuario);";
        $parms = array(
            ':flag' => $this->_flag,
            ':key' => $this->_key,
            ':rol' => $this->_rol,
            ':activo' => $this->_activo,
            ':clave' => ($this->_clave!=''?'S':'N'),
    ...
    public function mantenimientoRolOpcion(){
        $query = "call sp_rolesConfigurarRolesMantenimiento(:flag,:opcion,:rol,:activo,:clave,:usuario);";
        $parms = array(
            ':flag' => $this->_flag,
            ':opcion' => $this->_opcion,
            ':rol' => $this->_key,
    ...
    public function mantenimientoRolOpcionAccion(){
        $query = "call sp_rolesConfigurarRolesMantenimiento(:flag,:accion,:rolOpcion,:activo,:clave,:usuario);";
        $parms = array(
            ':flag' => $this->_flag,
            ':accion' => $this->_accion,
    ...
    public function postDuplicarRol(){
        $query = "call sp_rolesConfigurarRolesMantenimiento(:flag,:key,:rolOpcion,:activo,:clave,:usuario);";
        $parms = array(
            ':flag' => 8,
            ':key' => $this->_key,
            ':rolOpcion' => '',
