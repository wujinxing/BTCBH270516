...
class accionesModel extends Model{
    ...
    private function _set(){
        ...
        $this->_accion  = $this->post(T2.'txt_accion');
        $this->_alias   = $this->post(T2.'txt_alias');
        $this->_icono   = $this->post(T2.'txt_icono');
        $this->_theme   = $this->post(T2.'txt_theme');
        $this->_activo  = $this->post(T2.'chk_activo');
