...
<html lang="es">
    <head>
        ...
        <!-- Basic Styles -->
        <link rel="stylesheet" type="text/css" media="screen" href="<?php echo $rutaLayout['_css']; ?>bootstrap.min.css?v=<?php echo VERSION_CSS;?>">
        <link rel="stylesheet" type="text/css" media="screen" href="<?php echo BASE_URL; ?>public/css/font-awesome.min.css?v=<?php echo VERSION_CSS;?>">
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="<?php echo $rutaLayout['_css']; ?>demo.min.css?v=<?php echo VERSION_CSS;?> ">

        <link rel="stylesheet" type="text/css" media="screen" href="<?php echo BASE_URL ?>public/css/general<?php echo $min;?>.css?v=<?php echo VERSION_CSS;?>">
        
        <link rel="stylesheet" type="text/css" media="screen" href="<?php echo BASE_URL ?>public/css/scrollTable.min.css?v=<?php echo VERSION_CSS;?>">
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="<?php echo $rutaLayout['_js']; ?>plugin/jquery-timepicker/jquery.timepicker.css">
        <link rel="stylesheet" type="text/css" media="screen" href="<?php echo BASE_URL ?>public/js/jCrop/css/jquery.Jcrop.min.css">
