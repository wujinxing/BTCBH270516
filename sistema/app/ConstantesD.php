 ...
 */
define("INDEX","INDEX");       /*tab modulo CONFIGURACION DE ROLES*/
define("T1","T1XT1CRDCR");       /*tab modulo CONFIGURACION DE ROLES*/
define("T2","ACC");       /*tab modulo CONFIGURAR ACCIONES*/
define("T3","MENUPRIN");     /*tab modulo CONFIGURAR MENU*/
...
define("IDIOM","IDIOM");             /*tab modulo IDIOMAS*/
define("UBIG","UBIG");             /*tab modulo UBIGEO*/
define("ERRBD","ERRBD");             /*tab modulo ERRORBD*/
define("MOND","MOND");             /*tab modulo MONEDA*/
define("PLTDC","PLTDC");             /*tab modulo PLANTILLADOC*/
